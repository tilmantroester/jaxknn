...
from jaxknn.scipy_kdtree import knn_scipy as knn
...
def test_scipy_knn_interface(points, queries, box_size):
    k = 9
    idx = knn(
        points=points, k=k, queries=queries, box_size=box_size
    )
